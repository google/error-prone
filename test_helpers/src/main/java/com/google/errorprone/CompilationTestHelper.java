...
public class CompilationTestHelper {
   ...
   * disabled to test the interaction between Error Prone checks
  ...
  /**
   * By default, the compilation helper will only inspect diagnostics
   * generated by the check being tested. This behaviour can be
   * disabled to test the interaction between Error Prone checks
   * and javac diagnostics.
   */
  ...
  /**
   * Tells the compilation helper to expect a specific result from the compilation, e.g. success
   * or failure.
   */
