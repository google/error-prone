 ...
 *
 * <p>The annotated method must be marked {@code protected}, and must not be {@code static}, {@code
 * final} or declared in a {@code final} class. Overriding methods must be declared {@code
 * protected}, although their effective visibility is actually "none".
 */
@IncompatibleModifiers({STATIC, FINAL})
@RequiredModifiers(PROTECTED)
