---
title: ValueClassIdentity
summary: Value-based classes do not have identity; relying on identity semantics (such
  as WeakReference, IdentityHashMap, synchronization, or identity-based caches) is
...
## Suppression
Suppress false positives by adding the suppression annotation `@SuppressWarnings("ValueClassIdentity")` to the enclosing element.
