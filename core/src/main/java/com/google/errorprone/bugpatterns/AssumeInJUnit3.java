...
@BugPattern(
  name = "AssumeInJUnit3",
  summary =
      "Assume cannot be used in a JUnit3 context. Convert your class to JUnit4 style.",
  category = JUNIT,
  severity = WARNING
)
public class AssumeInJUnit3 extends BugChecker implements MethodInvocationTreeMatcher {
