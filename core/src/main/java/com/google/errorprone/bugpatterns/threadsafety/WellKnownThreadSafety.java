...
public final class WellKnownThreadSafety implements ThreadSafetyKnownTypes {
  ...
  private static ImmutableMap<String, AnnotationInfo> buildThreadSafeClasses(
    ...
    new MapBuilder()
        ...
        .add("kotlin.coroutines.CoroutineContext")
        .add("kotlin.coroutines.CoroutineContext$Element")
        .add("kotlin.time.TimeSource")
        .add("kotlin.time.TimeSource$Monotonic")
        .add("kotlin.time.TimeSource$WithComparableMarks")
        .add("kotlinx.atomicfu.AtomicArray", "T")
        .add("kotlinx.atomicfu.AtomicBoolean")
        .add("kotlinx.atomicfu.AtomicBooleanArray")
        .add("kotlinx.atomicfu.AtomicInt")
        .add("kotlinx.atomicfu.AtomicIntArray")
        .add("kotlinx.atomicfu.AtomicLong")
        .add("kotlinx.atomicfu.AtomicLongArray")
        .add("kotlinx.atomicfu.AtomicRef", "T")
        .add("kotlinx.coroutines.CompletableDeferred", "T")
        .add("kotlinx.coroutines.CompletableJob")
