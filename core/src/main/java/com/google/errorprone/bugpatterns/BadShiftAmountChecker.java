...
public class BadShiftAmountChecker extends BugChecker {
  ...
  private static final Matcher<BinaryTree> badShiftAmountMatcher =
    allOf(
      anyOf(
  ...
  public Description matchBinary(BinaryTree tree, VisitorState state) {
    if (badShiftAmountMatcher.matches(tree, state)) {
