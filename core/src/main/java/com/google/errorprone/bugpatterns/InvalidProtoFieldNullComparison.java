...
//TODO(eaftan): Rename to ProtoFieldNullComparison.
@BugPattern(name = "InvalidProtoFieldNullComparison",
...
public class InvalidProtoFieldNullComparison extends BugChecker implements BinaryTreeMatcher {
