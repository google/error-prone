 ...
 */
public class IsSameErasedType<T extends Tree> extends AbstractTypeMatcher<T> {

  public IsSameErasedType(Supplier<Type> typeToCompareSupplier) {
    super(typeToCompareSupplier);
  }

  public IsSameErasedType(String typeString) {
    super(typeString);
  }
