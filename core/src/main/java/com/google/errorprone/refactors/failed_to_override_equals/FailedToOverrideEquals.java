 ...
 */
@BugPattern(name = "failed to override equals",
...
public class FailedToOverrideEquals extends RefactoringMatcher<MethodTree> {
  @Override
  ...
  public static class Scanner extends com.google.errorprone.Scanner {
    private FailedToOverrideEquals matcher = new FailedToOverrideEquals();
