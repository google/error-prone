...
public class CovariantEquals extends RefactoringMatcher<MethodTree> {
  ...
  /**
   * Matches any method definitions that fit the following: 1) Defined method is named "equals." 2)
   * Defined method returns a boolean. 3) Defined method takes a single parameter of the same type
   * as the enclosing class. 4) The enclosing class does not have a method defined that really
