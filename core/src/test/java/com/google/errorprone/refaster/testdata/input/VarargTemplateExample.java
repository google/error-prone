...
public class VarargTemplateExample {
  ...
  public String foo0_empty() {
    return String.format("first: %s, second: %s", new Object[]{});
  }

  public String foo1() {
    return String.format("first: %s, second: %s", new Object[]{"first"});
  }

  public String foo2() {
    return String.format("first: %s, second: %s", new Object[]{"first", "second"});
  }
