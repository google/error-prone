...
public class TemplatingTest extends CompilerBasedTest {
        ...
        ExpressionTemplate.create(
            ...
            UBinary.create(Kind.DIVIDE, 
                UParens.create(UBinary.create(
                    Kind.PLUS, UFreeIdent.create("x"), UFreeIdent.create("y"))),
                ULiteral.intLit(2)),
            UPrimitiveType.INT),
        UTemplater.createTemplate(context, getMethodDeclaration("example")));
  }
  ...
  public void fullyQualifiedGlobalIdent() {
    ...
    assertEquals(
        ExpressionTemplate.create(
            UStaticIdent.create("java.math.RoundingMode", "FLOOR", 
  ...
  public void instanceMethodInvocation() {
    ...
    assertEquals(
        ExpressionTemplate.create(
            ...
            UMethodInvocation.create(
                UMemberSelect.create(UFreeIdent.create("str"), "charAt", 
  ...
  public void unary() {
    ...
    assertEquals(
        ExpressionTemplate.create(
            ImmutableMap.of(
                "array", UArrayType.create(UPrimitiveType.INT),
                "key", UPrimitiveType.INT),
            UUnary.create(
                Kind.BITWISE_COMPLEMENT, 
                UMethodInvocation.create(
                    UStaticIdent.create("java.util.Arrays", "binarySearch",
                        UMethodType.create(
                            UPrimitiveType.INT, 
        ...
        BlockTemplate.create(
            ...
            UExpressionStatement.create(UMethodInvocation.create(
                UMemberSelect.create(
                    ...
                    UMethodType.create(
                        UPrimitiveType.VOID, 
                        UArrayType.create(UPrimitiveType.BYTE))), 
    ...
    assertEquals(
        BlockTemplate.create(
            ...
            UForLoop.create(
                ...
                UBinary.create(
                    Kind.LESS_THAN, 
                    ULocalVarIdent.create("i"), 
                    UFreeIdent.create("to")), 
  ...
  public void throwException() {
    ...
    assertEquals(
        BlockTemplate.create(
            UThrow.create(UNewClass.create(
    ...
    assertEquals(
        BlockTemplate.create(
            ...
            USynchronized.create(
                ...
                UBlock.create(UEnhancedForLoop.create(
                    UVariableDecl.create("value", UPrimitiveTypeTree.INT), 
                    UFreeIdent.create("array"), 
                    UBlock.create(UExpressionStatement.create(
                        UAssignOp.create(
