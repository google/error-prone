...
/** Test cases to ensure SuppressLint annotation is respected. */
@SuppressLint("DeadException")
public class SuppressLintNegativeCases {
  ...
  @SuppressLint({"bar", "SelfAssignment"})
