...
""")
  ...
  public void ifChain_loopContextYield_noError() {
    // Putting a switch in anohther switch will change the meaning of the `yield`
    helper
        .addSourceLines(
            "Test.java",
            """
  ...
  public void ifChain_nonVarSubject_noError() {
    // Should not just compare method name (e.g. `hashCode`)
    helper
        .addSourceLines(
            "Test.java",
            """
            ...
            class Test {
              public void foo(Suit s) {
                ...
                if (i == 88) {
                  ...
                  System.out.println("i is one again 88");
                }
              }
            }
            """)
