...
public final class TimeInStaticInitializerTest {
  ...
  @Test
  public void positive_instantSource() {
    helper
        .addSourceLines(
            "Test.java",
            """
            ...
            class Test {
              // BUG: Diagnostic contains:
              private static final Instant NOW = InstantSource.system().instant();

              // BUG: Diagnostic contains:
              private static final Instant NOW2 = TimeSource.system().instant();
            }
            """)
        .doTest();
  }
