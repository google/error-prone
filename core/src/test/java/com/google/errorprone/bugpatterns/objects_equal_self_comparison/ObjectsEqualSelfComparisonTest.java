...
public class ObjectsEqualSelfComparisonTest {
  ...
  public void setUp() {
    ...
    compiler = new ErrorProneCompiler.Builder()
        .report(new ObjectsEqualSelfComparison.Scanner())
  ...
  public void testPositiveCase() throws Exception {
    ...
    Matcher<Iterable<? super Diagnostic<JavaFileObject>>> matcher = hasItem(diagnosticMessage(
        containsString("Did you mean 'return Objects.equal(field, other.field)")));
