  ...
  public void negative_methodCall_fromNullUnmarkedClass_inNullMarkedScope() {
    compilationHelper
        ...
        .addSourceLines(
            ...
            class Test {
              void process() {
                if (NullUnmarkedLib.getString() == null) {
                  /* This is fine */
                }
              }
            }
    ...
    compilationHelper
        .addSourceLines(
            ...
            class Test<T> {
              void foo(T t) {
                if (t == null) {
                  /* This is fine, T could be nullable */
                }
              }
            }
            """)
            ...
            class Test {
              void foo() {
                Consumer<String> consumer =
                    s -> {
                      if (s == null) {
                        /* This is fine, inferred type might be nullable */
                      }
                    };
              }
            }
