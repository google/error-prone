  ...
  public void testInstanceMethod_privateVariable() {
    helper
        .addSourceLines(
            ...
            "  @Deprecated",
            "  // BUG: Diagnostic contains: deprecated or non-public API elements: str",
  ...
  public void testInstanceMethod_privateMethod() {
    helper
        .addSourceLines(
            ...
            "  @Deprecated",
            "  // BUG: Diagnostic contains: deprecated or non-public API elements: privateMethod()",
            "  public String before() {",
  ...
  public void testAssignmentToPrivateField() {
    helper
        .addSourceLines(
            ...
            "  @Deprecated",
            "  // BUG: Diagnostic contains: deprecated or non-public API elements: this.name",
