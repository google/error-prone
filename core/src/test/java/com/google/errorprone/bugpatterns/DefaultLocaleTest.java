  ...
  public void dateFormat() {
    compilationHelper
        .addSourceLines(
            ...
            "class Test {",
            "  void f() throws Exception {",
            "    // BUG: Diagnostic contains: DateFormat.getDateTimeInstance(SHORT, SHORT, Locale.getDefault(FORMAT));",
            ...
            "    // BUG: Diagnostic contains: DateFormat.getDateTimeInstance(DEFAULT, DEFAULT, Locale.getDefault(FORMAT));",
            "    DateFormat.getDateTimeInstance();",
            "    // BUG: Diagnostic contains: DateFormat.getDateTimeInstance(SHORT, LONG, Locale.getDefault(FORMAT));",
  ...
  public void resourceBundle() {
    compilationHelper
        .addSourceLines(
            ...
            "import java.util.*;",
            "class Test {",
            "  void f(ResourceBundle.Control control, Locale locale, ClassLoader cl) throws Exception {",
            "    // BUG: Diagnostic contains: ResourceBundle.getBundle(\"name\", Locale.getDefault());",
            "    ResourceBundle.getBundle(\"name\");",
            "    // BUG: Diagnostic contains: ResourceBundle.getBundle(\"name\", Locale.getDefault(), control);",
  ...
  public void resourceBundleJdk9plus() {
    ...
    compilationHelper
        .addSourceLines(
            ...
            "import java.util.*;",
            "class Test {",
            "  void f(ResourceBundle.Control control, Locale locale, Module module) throws Exception {",
            "    // BUG: Diagnostic contains: ResourceBundle.getBundle(\"name\", Locale.getDefault(), module);",
    ...
    compilationHelper
        .addSourceLines(
            ...
            "    // BUG: Diagnostic contains: "
                + "new DecimalFormat(\"000\", DecimalFormatSymbols.getInstance(Locale.getDefault(FORMAT)));",
  ...
  public void simpleDateFormat() {
    compilationHelper
        .addSourceLines(
            ...
            "    // BUG: Diagnostic contains: new SimpleDateFormat(\"yMd\", Locale.getDefault(FORMAT));",
  ...
  public void formatter() {
    compilationHelper
        .addSourceLines(
            ...
            "    new Formatter();",
            "    // BUG: Diagnostic contains: new Formatter(new StringBuilder(), Locale.getDefault(FORMAT));",
            "    new Formatter(new StringBuilder());",
            "    // BUG: Diagnostic matches: NoFix",
            "    new Formatter(\"filename\");",
            "    // BUG: Diagnostic contains: new Formatter(\"filename\", \"utf8\", Locale.getDefault(FORMAT));",
            "    new Formatter(\"filename\", \"utf8\");",
            "    // BUG: Diagnostic matches: NoFix",
            "    new Formatter(file);",
            "    // BUG: Diagnostic contains: new Formatter(file, \"utf8\", Locale.getDefault(FORMAT));",
            "    new Formatter(file, \"utf8\");",
            "    // BUG: Diagnostic matches: NoFix",
            "    new Formatter(System.out);",
            "    // BUG: Diagnostic matches: NoFix",
            "    new Formatter(os);",
            "    // BUG: Diagnostic contains: new Formatter(os, \"utf8\", Locale.getDefault(FORMAT));",
