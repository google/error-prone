...
ERROR_PRONE_JAR=... @ path to error_prone_ant-2.1.1.jar
...
```
wget https://repo1.maven.org/maven2/com/google/errorprone/error_prone_ant/2.1.1/error_prone_ant-2.1.1.jar
java -Xbootclasspath/p:error_prone_ant-2.1.1.jar com.google.errorprone.ErrorProneCompiler Test.java
```
