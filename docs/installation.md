...
ERROR_PRONE_JAR=... @ path to error_prone_ant-2.2.0.jar
...
```
wget https://repo1.maven.org/maven2/com/google/errorprone/error_prone_ant/2.2.0/error_prone_ant-2.2.0.jar
java -Xbootclasspath/p:error_prone_ant-2.2.0.jar com.google.errorprone.ErrorProneCompiler Test.java
```
