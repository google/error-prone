...
```
wget https://repo1.maven.org/maven2/com/google/errorprone/error_prone_ant/2.0.16/error_prone_ant-2.0.16.jar
java -Xbootclasspath/p:error_prone_ant-2.0.16.jar com.google.errorprone.ErrorProneCompiler Test.java
```
