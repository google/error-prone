...
```
wget https://repo1.maven.org/maven2/com/google/errorprone/error_prone_ant/2.0.17/error_prone_ant-2.0.17.jar
java -Xbootclasspath/p:error_prone_ant-2.0.17.jar com.google.errorprone.ErrorProneCompiler Test.java
```
